...
const AboutPage = () => {
  return (
    <div className={`px-4 lg:flex lg:flex-col lg:items-center mb-10`}>
      <h1
        className={`font-spoqa-medium text-5xl pt-[72px] lg:text-[80px] lg:text-center`}
      >
        모든 디지털 <br className={`lg:hidden`} />
        유목민을 위한 <br /> 유목생활 지도
      </h1>
      ...
      <p className={`font-spoqa-light mt-10`}>
        <span className={`font-spoqa-regular`}>Jang&Brouk Nomad Seoul</span>은
        디지털 노마드들의 라이프스타일과 경험을 공유하고, 디지털 노마드들의 길을
        갈때 도움을 주는 서비스입니다.
        <br />
        우리는 서로의 경험을 공유하고 자기자신만의 길을 찾아가는 것에 가치가
        있다고 믿습니다. 무엇보다 우리는 서로의 삶을 존중하고, 서로의 삶의
        방식에 대해서 무조건적으로 지원하고 지지합니다.
      </p>
      ...
      <p className={`font-spoqa-light mt-10`}>
        디지털 노마드의 라이프스타일에 참여해보세요, 자신에게 맞다면 함께
        정처없이 떠돌아다니는 그 옛날 유목민이지만, 스마트하게 "나"에게 더
        집중하면서 살아봅시다.
      </p>
    </div>
  );
